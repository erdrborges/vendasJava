...
import com.example.vendasjava.adapter.ClientesAdapter;
import com.example.vendasjava.adapter.ProdutosAdapter;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.menuitem_barcode:
                ...
                //incluir um case com a implementação do botão de retornar a activity no menu, dando o devido tratamento
        }
